    ...
    <link rel="stylesheet" type="text/css" href="css/akomodasi.css">
    </head>
    <body>
       ...
       <main class="mt-5">
           <div class="container">
               ...
               <section id="culinary" class="text-center">
                   ...
                   <!-- Heading -->
                   <h2 class="mb-5 font-weight-bold">Macam-Macam Properti</h2>
                   ...
                   <div class="row">
                       ...
                       <div class="col-lg-3 col-md-4 mb-4">
                           ...
                           <div class="card bg-dark text-white">
                             <img class="card-img image-kuliner" src="https://pix10.agoda.net/hotelImages/96605/-1/dd32d9b188d86d6d8dc40d1ff9a0ebf6.jpg?s=1024x768" alt="Card image">
                       ...
                       <div class="col-lg-3 col-md-4 mb-4">
                           ...
                           <div class="card bg-dark text-white">
                             ...
                             <div class="card-img-overlay">
                               <br>
                               <br>
                               <h5 class="card-title">Hotel Bintang 4.5</h5>
                             </div>
                           </div>
                           </a>
               ...
               <section id="culinary" class="text-left">
                   ...
                   <div class="row">
                     <div class="col-md-6">
                       <!-- Heading -->
                       <h2 class="mb-5 font-weight-bold">Akomodasi Terbaik Sekitar Malang</h2>
                     </div>
                     <div class="col-md-3 ml-md-auto">
                       <br>
                       <a href="kuliner.php"><h6>Lihat Semuanya</h6></a>
                     </div>
                   </div>
                   ...
                   <div class="row">
                       ...
                       <div class="col-lg-3 col-md-4 mb-4">
                           ...
                           <div class="view overlay z-depth-1-half">
                               <img src="https://q-cf.bstatic.com/images/hotel/max1024x768/205/205076303.jpg" class="img-fluid" alt="">
                               <div class="mask rgba-white-slight"></div>
                           </div>

                           <h4 class="my-4 font-weight-bold">Hotel Palangka Raya</h4>
               ...
               <section id="culinary" class="text-left">
                   ...
                   <div class="row">
                     <div class="col-md-6">
                       <!-- Heading -->
                       <h3 class="mb-5 font-weight-bold">Akomodasi Bintang 5 Sekitar Malang</h3>
                     </div>
                     <div class="col-md-3 ml-md-auto">
                       <br>
                       <a href="kuliner.php"><h6>Lihat Semuanya</h6></a>
                   ...
                   <div class="row">
                       ...
                       <div class="col-lg-3 col-md-4 mb-4">
                           ...
                           <div class="view overlay z-depth-1-half">
                               <img src="https://static.tiket.photos/image/upload/v1566250438/hotel/images-web/2019/08/20/a23625f7-a744-41ba-b089-0b575eed3c0c-1566250435506-2f1faca20659a293f62a4df3dc19b79f.jpg" class="img-fluid" alt="">
                               <div class="mask rgba-white-slight"></div>
                           </div>

                           <h4 class="my-4 font-weight-bold">Royal Tulip</h4>
                           <span class="grey-text"><i class="fa fa-map-marker" aria-hidden="true"></i> Malang</span>
                           <br class="grey-text"><span class="fa fa-star checked"></span>
                           <span class="fa fa-star checked"></span>
                           <span class="fa fa-star checked"></span>
               ...
               <section id="culinary" class="text-left">
                 ...
                 <div class="row">
                   <div class="col-md-6">
                     <!-- Heading -->
                     <h3 class="mb-5 font-weight-bold">Akomodasi Sekitar Malang</h3>
                   </div>
                   <div class="col-md-3 ml-md-auto">
                     <br>
                     <a href="kuliner.php"><h6>Lihat Semuanya</h6></a>
