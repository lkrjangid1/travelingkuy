...
<div class="container">
    ...
    <div class="row" id="video">
      ...
      <div class="col-lg-3 col-md-6 mb-4 margin-video">
        ...
        <h6 class="my-2 font-weight-bold">Villa Murah di Bali</h6>
          <p class="card-text"><i class="fa fa-clock-o" aria-hidden="true"></i> Sabtu, September 07, 2019 00.00</p>
      </div>
    ...
    <div class="col-lg-3 col-md-6 mb-4 margin-video">
        ...
        <h6 class="my-2 font-weight-bold">Pantai Sawangan Bali, nikmati kesendirian di pantai.</h6>
          <p class="card-text"><i class="fa fa-clock-o" aria-hidden="true"></i>  Jumat, September 06, 2019 00.00</p>
      </div>
      ...
      <div class="col-lg-3 col-md-6 mb-4 margin-video">
        ...
        <h6 class="my-2 font-weight-bold">Pantai Sawangan Bali, nikmati kesendirian di pantai.</h6>
          <p class="card-text"><i class="fa fa-clock-o" aria-hidden="true"></i> Kamis, September 05, 2019 00.00</p>
      </div>
    </div>
      <div class="row" id="video">
      <div class="col-lg-3 col-md-6 mb-4 margin-video">
        ...
        <h6 class="my-2 font-weight-bold">Bakau diolah jadi Makanan Lezat!</h6>
          <p class="card-text"><i class="fa fa-clock-o" aria-hidden="true"></i> Rabu, September 04, 2019 00.00</p>
      </div>
      ...
      <div class="col-lg-3 col-md-6 mb-4 margin-video">
        ...
        <h6 class="my-2 font-weight-bold">Nasi Punel Bangil, kenikmatan yang perlu kalian coba guys....</h6>
          <p class="card-text"><i class="fa fa-clock-o" aria-hidden="true"></i> Selasa, September 03, 2019 00.00</p>
      </div>
    ...
    <div class="col-lg-3 col-md-6 mb-4 margin-video">
        ...
        <h6 class="my-2 font-weight-bold">Tegenungan Waterfall, air terjun cantik Bali</h6>
          <p class="card-text"><i class="fa fa-clock-o" aria-hidden="true"></i> Senin, September 02, 2019 00.00</p>
      </div>
